...
; [eval] address(3)
(push) ; 3
(assert (address%precondition $Snap.unit 3))
(pop) ; 3
; Joined path conditions
(assert (address%precondition $Snap.unit 3))
(declare-const $t@0@03 Int)
(declare-const sm@1@03 $FVF<val>)
; Definitional axioms for singleton-SM's value
(assert (= ($FVF.lookup_val (as sm@1@03  $FVF<val>) (address $Snap.unit 3)) $t@0@03))
(assert (<=
  $Perm.No
  (ite
    (= (address $Snap.unit 3) (address $Snap.unit 3))
    (/ (to_real 1) (to_real 2))
    $Perm.No)))
(assert (<=
  (ite
...
(assert (=>
  (= (address $Snap.unit 3) (address $Snap.unit 3))
  (not (= (address $Snap.unit 3) $Ref.null))))
...
(set-option :timeout 0)
(push) ; 3
(assert (address%precondition $Snap.unit 2))
(pop) ; 3
; Joined path conditions
(assert (address%precondition $Snap.unit 2))
(declare-const $t@2@03 Int)
(declare-const sm@3@03 $FVF<val>)
; Definitional axioms for singleton-SM's value
(assert (= ($FVF.lookup_val (as sm@3@03  $FVF<val>) (address $Snap.unit 2)) $t@2@03))
(assert (<=
  $Perm.No
  (ite
    (= (address $Snap.unit 2) (address $Snap.unit 2))
    (/ (to_real 1) (to_real 2))
    $Perm.No)))
(assert (<=
  (ite
...
(assert (=>
  (= (address $Snap.unit 2) (address $Snap.unit 2))
  (not (= (address $Snap.unit 2) $Ref.null))))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(set-option :timeout 0)
(push) ; 3
(assert (address%precondition $Snap.unit 1))
(pop) ; 3
; Joined path conditions
(assert (address%precondition $Snap.unit 1))
(declare-const $t@4@03 Int)
(declare-const sm@5@03 $FVF<val>)
; Definitional axioms for singleton-SM's value
(assert (= ($FVF.lookup_val (as sm@5@03  $FVF<val>) (address $Snap.unit 1)) $t@4@03))
(assert (<=
  $Perm.No
  (ite
    (= (address $Snap.unit 1) (address $Snap.unit 1))
    (/ (to_real 1) (to_real 2))
    $Perm.No)))
(assert (<=
  (ite
...
(assert (=>
  (= (address $Snap.unit 1) (address $Snap.unit 1))
  (not (= (address $Snap.unit 1) $Ref.null))))
; State saturation: after inhale
(set-option :timeout 20)
(check-sat)
; unknown
...
(declare-const i@6@03 Int)
(set-option :timeout 0)
(push) ; 3
; [eval] 1 <= i && i <= 3
; [eval] 1 <= i
(push) ; 4
; [then-branch: 0 | 1 <= i@6@03 | live]
; [else-branch: 0 | !(1 <= i@6@03) | live]
(push) ; 5
; [then-branch: 0 | 1 <= i@6@03]
(assert (<= 1 i@6@03))
; [eval] i <= 3
(pop) ; 5
(push) ; 5
; [else-branch: 0 | !(1 <= i@6@03)]
(assert (not (<= 1 i@6@03)))
(pop) ; 5
(pop) ; 4
; Joined path conditions
; Joined path conditions
(assert (or (not (<= 1 i@6@03)) (<= 1 i@6@03)))
(assert (and (<= i@6@03 3) (<= 1 i@6@03)))
; [eval] address(i)
(push) ; 4
(assert (address%precondition $Snap.unit i@6@03))
(pop) ; 4
; Joined path conditions
(assert (address%precondition $Snap.unit i@6@03))
(pop) ; 3
(declare-fun inv@7@03 ($Ref) Int)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@6@03 Int)) (!
  (=>
    (and (<= i@6@03 3) (<= 1 i@6@03))
    (and
      (or (not (<= 1 i@6@03)) (<= 1 i@6@03))
      (address%precondition $Snap.unit i@6@03)))
  :pattern ((address $Snap.unit i@6@03))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@6@03 Int) (i2@6@03 Int)) (!
  (=>
    (and
      (=>
        (and
          (and (<= i1@6@03 3) (<= 1 i1@6@03))
          (and (<= i2@6@03 3) (<= 1 i2@6@03)))
        (and
          (address%precondition $Snap.unit i1@6@03)
          (address%precondition $Snap.unit i2@6@03)))
      (and
        (and (<= i1@6@03 3) (<= 1 i1@6@03))
        (and (<= i2@6@03 3) (<= 1 i2@6@03))
        (= (address $Snap.unit i1@6@03) (address $Snap.unit i2@6@03))))
    (= i1@6@03 i2@6@03))
...
(assert (not (and
  ...
  (not
    (=
      ($FVF.lookup_val (as sm@5@03  $FVF<val>) (address $Snap.unit 1))
      ($FVF.lookup_val (as sm@3@03  $FVF<val>) (address $Snap.unit 2)))))))
(check-sat)
; unknown
(get-model)
(pop) ; 3
...
(assert (not (and
  ...
  (not
    (=
      ($FVF.lookup_val (as sm@5@03  $FVF<val>) (address $Snap.unit 1))
      ($FVF.lookup_val (as sm@1@03  $FVF<val>) (address $Snap.unit 3)))))))
(check-sat)
; unknown
(get-model)
(pop) ; 3
...
; 0.00s
; (get-info :all-statistics)
(declare-const sm@8@03 $FVF<val>)
; Definitional axioms for snapshot map values
(assert (forall ((r $Ref)) (!
  (=>
    (= r (address $Snap.unit 1))
    (=
      ($FVF.lookup_val (as sm@8@03  $FVF<val>) r)
      ($FVF.lookup_val (as sm@5@03  $FVF<val>) r)))
  :pattern (($FVF.lookup_val (as sm@8@03  $FVF<val>) r))
  :pattern (($FVF.lookup_val (as sm@5@03  $FVF<val>) r))
  :qid |qp.fvfValDef0|)))
(assert (forall ((r $Ref)) (!
  (=>
    (= r (address $Snap.unit 2))
    (=
      ($FVF.lookup_val (as sm@8@03  $FVF<val>) r)
      ($FVF.lookup_val (as sm@3@03  $FVF<val>) r)))
  :pattern (($FVF.lookup_val (as sm@8@03  $FVF<val>) r))
  :pattern (($FVF.lookup_val (as sm@3@03  $FVF<val>) r))
  :qid |qp.fvfValDef1|)))
(assert (forall ((r $Ref)) (!
  (=>
    (= r (address $Snap.unit 3))
    (=
      ($FVF.lookup_val (as sm@8@03  $FVF<val>) r)
      ($FVF.lookup_val (as sm@1@03  $FVF<val>) r)))
  :pattern (($FVF.lookup_val (as sm@8@03  $FVF<val>) r))
  :pattern (($FVF.lookup_val (as sm@1@03  $FVF<val>) r))
  :qid |qp.fvfValDef2|)))
(declare-const pm@9@03 $FPM)
(assert (forall ((r $Ref)) (!
  (=
    ($FVF.perm_val (as pm@9@03  $FPM) r)
    (+
      (+
        (ite (= r (address $Snap.unit 1)) (/ (to_real 1) (to_real 2)) $Perm.No)
        (ite (= r (address $Snap.unit 2)) (/ (to_real 1) (to_real 2)) $Perm.No))
      (ite (= r (address $Snap.unit 3)) (/ (to_real 1) (to_real 2)) $Perm.No)))
  :pattern (($FVF.perm_val (as pm@9@03  $FPM) r))
  :qid |qp.resPrmSumDef3|)))
(assert (<= ($FVF.perm_val (as pm@9@03  $FPM) (address $Snap.unit 1)) $Perm.Write))
(assert (<= ($FVF.perm_val (as pm@9@03  $FPM) (address $Snap.unit 2)) $Perm.Write))
(assert (<= ($FVF.perm_val (as pm@9@03  $FPM) (address $Snap.unit 3)) $Perm.Write))
(declare-const i@10@03 Int)
(set-option :timeout 0)
(push) ; 3
; [eval] 1 <= i && i <= 3
; [eval] 1 <= i
(push) ; 4
; [then-branch: 1 | 1 <= i@10@03 | live]
; [else-branch: 1 | !(1 <= i@10@03) | live]
(push) ; 5
; [then-branch: 1 | 1 <= i@10@03]
(assert (<= 1 i@10@03))
; [state consolidation]
; State saturation: before repetition
(set-option :timeout 10)
...
(set-option :timeout 0)
(push) ; 5
; [else-branch: 1 | !(1 <= i@10@03)]
(assert (not (<= 1 i@10@03)))
; [state consolidation]
; State saturation: before repetition
(set-option :timeout 10)
(check-sat)
...
; Joined path conditions
; Joined path conditions
(assert (or (not (<= 1 i@10@03)) (<= 1 i@10@03)))
(assert (and (<= i@10@03 3) (<= 1 i@10@03)))
; [eval] address(i)
(set-option :timeout 0)
(push) ; 4
(assert (address%precondition $Snap.unit i@10@03))
(pop) ; 4
; Joined path conditions
(assert (address%precondition $Snap.unit i@10@03))
(pop) ; 3
(declare-fun inv@11@03 ($Ref) Int)
; Nested auxiliary terms: globals
; Nested auxiliary terms: non-globals
(assert (forall ((i@10@03 Int)) (!
  (=>
    (and (<= i@10@03 3) (<= 1 i@10@03))
    (and
      (or (not (<= 1 i@10@03)) (<= 1 i@10@03))
      (address%precondition $Snap.unit i@10@03)))
  :pattern ((address $Snap.unit i@10@03))
  :qid |val-aux|)))
; Check receiver injectivity
(push) ; 3
(assert (not (forall ((i1@10@03 Int) (i2@10@03 Int)) (!
  (=>
    (and
      (=>
        (and
          (and (<= i1@10@03 3) (<= 1 i1@10@03))
          (and (<= i2@10@03 3) (<= 1 i2@10@03)))
        (and
          (address%precondition $Snap.unit i1@10@03)
          (address%precondition $Snap.unit i2@10@03)))
      (and
        (and (<= i1@10@03 3) (<= 1 i1@10@03))
        (and (<= i2@10@03 3) (<= 1 i2@10@03))
        (= (address $Snap.unit i1@10@03) (address $Snap.unit i2@10@03))))
    (= i1@10@03 i2@10@03))
